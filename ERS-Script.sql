...
insert into WORKER (workerId, lastName, firstName, username, passCode, title, reportsTo, hireDate, streetAddress, city, state, zip, phone, email) values (worker_seq.nextval, 'Doe', 'John', 'ecockney4', 'vFPROSjd3', 'Manager', 0, '5/7/2019', '0 Hovde Way', 'Clearwater', 'Florida', '34629', '727-798-2321', 'ecockney4@time.com');
